...
(fn DIR &key FLAKE-REF)" t)
 (autoload 'nix-flake-init-dispatch "nix-flake" nil t)
(autoload 'nix-flake-init "nix-flake" "\
Run \"nix flake init\" command via a transient interface." t)
(autoload 'nix-flake-lock-mode "nix-flake")
(add-to-list 'auto-mode-alist '("/flake\\.lock\\'" . nix-flake-lock-mode))
(register-definition-prefixes "nix-flake" '("nix-flake-"))


;;; Generated autoloads from nix-format.el

 (autoload 'nix-format-buffer "nix-format" nil t)
 (autoload 'nix-format-region "nix-format" nil t)
 (autoload 'nix-format-on-save-mode "nix-format" nil t)
(register-definition-prefixes "nix-format" '("nix-nixfmt-"))
